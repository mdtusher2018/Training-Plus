...
class AfterSignUpOtpView extends StatefulWidget {
  const AfterSignUpOtpView({super.key});

  @override
  State<AfterSignUpOtpView> createState() => _AfterSignUpOtpViewState();
}

class _AfterSignUpOtpViewState extends State<AfterSignUpOtpView> {
